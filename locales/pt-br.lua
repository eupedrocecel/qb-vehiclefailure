local Translations = {
    error = {
        ...
        ["roadside_avail"] = "Há assistência rodoviária disponível, chame através do seu telefone!",
        ...
        ["nofix_message_3"] = "Você olhou para a fita adesiva em sua mangueira de óleo e parecia boa",
        ["nofix_message_4"] = "Você aumentou o volume do rádio. O estranho barulho do motor desapareceu",
    ...
    success = {
        ...
        ["fix_message_2"] = "Você fechou o vazamento de óleo com goma de mascar",
